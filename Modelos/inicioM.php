...
require_once "ConexionBD.php";
    ...
    class InicioM extends ConexionBD {
        ...
        static public function MostrarInicioM($tablaBD, $id){
            ...
            $pdo = ConexionBD::cBD()->prepare("SELECT id, intro, horaE, horaS, direccion, telefono, telefono1, correo, correo1, logo, favicon FROM $tablaBD 
            WHERE id = :id");
	...
	static public function ActualizarInicioM($tablaBD, $datosC){
		...
		telefono = :telefono, correo = :correo, telefono1 = :telefono1, correo1 = :correo1, logo = :logo, favicon = :favicon WHERE id = :id");
