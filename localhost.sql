...
--
-- Host: localhost
-- Generation Time: Jan 16, 2023 at 06:47 PM
...
-- Database: `viajesfya`
--
CREATE DATABASE IF NOT EXISTS `viajesfya` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `viajesfya`;
...
(1, 'Bienvenid@s miembros de la comunidad de Fe y alegría, la presente plataforma nos permitira organizar nuestras labores de mejor manera teniendo en cuenta las actividades laborales fuera de la oficina como viajes o vacaciones  de nuestros  compañeros. Comencemos!!!', '00:00:00', '00:00:00', '993753004', 'jmilian@feyalegria.org.pe', 'Jirón Cahuide 884 - Jesús María', 'Vistas/img/logo.jpeg', 'Vistas/img/favicon.png');
...
--
-- Table structure for table `otrosTrabajadores`
--
...
--
-- Dumping data for table `otrosTrabajadores`
--
...
--
-- Table structure for table `vueloslogistica`
--
...
--
-- Dumping data for table `vueloslogistica`
--
...
--
-- Indexes for table `otrosTrabajadores`
--
...
--
-- Indexes for table `vueloslogistica`
--
...
--
-- AUTO_INCREMENT for table `jefesarea`
--
ALTER TABLE `jefesarea`
...
--
-- AUTO_INCREMENT for table `otrosTrabajadores`
--
ALTER TABLE `otrosTrabajadores`
...
--
-- AUTO_INCREMENT for table `vueloslogistica`
--
ALTER TABLE `vueloslogistica`
